...
context master {
    ...
    entity businesspartner {
        ...
        BP_ROLE: String(2);
        EMAIL_ADDRESS: String(105) @title:'{i18n>PARTNER_GUID.EMAIL_ADDRESS}';
    ...
    entity product{
        ...
        TYPE_CODE: String(2) @title:'{i18n>PRODUCT_GUID.TYPE_CODE}';
        CATEGORY: String(32) @title :'{i18n>PRODUCT_GUID.CATEGORY}'; 
